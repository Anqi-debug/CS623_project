...
insert into product values('p4' , 'monitor' , 80);

insert into depot values('d1' , 'New York' , 9000);
insert into depot values('d2' , 'Syracuse' , 6000);
insert into depot values('d3' , 'Syracuse' , 6000);
insert into depot values('d4' , 'Washington' , 2000);
...
insert into stock values('p4', 'd4' , 3500);
insert into stock values('p4', 'd2' , 2000);
...
ALTER TABLE stock ADD CONSTRAINT fk_stock
FOREIGN KEY(prod_id) REFERENCES product(prod_id) ON DELETE CASCADE;

ALTER TABLE stock ADD CONSTRAINT fk_stock1
